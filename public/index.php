...
<div id="main">
    ...
    <div id="page">
        <?php
         if (isset($page)) {
             $allowed_tags = '<div><img><h1><h2><p><strong><em><ul><li>';
             echo strip_tags(($page['content']), $allowed_tags);
         } else {
             //Show the homepage
             //The homepage content could:
             //*Be static content (here or shared file)
             //*Show the firstpage from the nav
             //*Be in the database but add code to hide in the raw
